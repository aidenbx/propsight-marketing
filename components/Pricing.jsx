  ...
  const cards = [
    {
      ...
      sub: 'Always free',
      features: [
        { included: true,  text: '5 property matches per week' },
        { included: true,  text: 'Weekly Monday morning digest' },
        { included: true,  text: 'Basic AI match score + tags' },
        { included: true,  text: 'Borrowing power estimator' },
        { included: true,  text: '15km search radius' },
        { included: false, text: 'Daily digest (Monday to Sunday)' },
        { included: false, text: 'AI score explanation — why it scored' },
    ...
    },
    {
      ...
      features: [
        ...
        { included: true,  text: 'Daily morning digest' },
        { included: true,  text: 'AI score explanation — why it scored' },
        { included: true,  text: 'Investment goal customisation' },
        { included: true,  text: 'Inspection scheduler + Saturday route' },
        { included: true,  text: 'Daily infrastructure signals' },
        { included: true,  text: 'Suburb comparison tool' },
        { included: true,  text: 'Suburb insights and price trends' },
        { included: true,  text: 'Unlimited search radius' },
        { included: true,  text: 'Borrowing power on every listing' },
      ],
      cta: 'Get started',
      dark: true,
      featured: true,
    },
    {
      ...
      features: [
        ...
        { included: true, text: 'Capital gains signals — high impact only' },
        { included: true, text: 'Suburb momentum — Rising/Peak/Declining' },
        { included: true, text: 'Price drop alerts on saved properties' },
        { included: true, text: 'Priority scoring — first in pipeline' },
      ],
      cta: 'Get Premium',
      dark: false,
      featured: false,
        ...
        <AnimateOnScroll delay={0.3}>
          <div style={{ textAlign: 'center', marginTop: 40 }}>
            <p style={{ fontSize: 14, color: '#636366', margin: '0 0 6px', fontWeight: 500 }}>
              No lock-in contracts · Cancel anytime · Save 20% with annual billing
            </p>
